...
#ifndef LENGTHWIDTHHEIGHT_H
#define LENGTHWIDTHHEIGHT_H
...
class LengthWidthHeight : public DimsFunctor {
 public:
  static DimsFunctor* get();
  static LengthWidthHeight* singleton;

  LengthWidthHeight();
  virtual ~LengthWidthHeight();
