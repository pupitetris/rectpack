...
#ifndef PRECOMPUTEDSUMS_H
#define PRECOMPUTEDSUMS_H
...
class PrecomputedSums : public RatPack {
 public:
  PrecomputedSums();
  virtual ~PrecomputedSums();
 ...
 private:
  bool packInterval(RectPtrArray::iterator i);
  bool packSingle(const Compulsory* c, RectPtrArray::iterator i);
  bool nextVariable(RectPtrArray::iterator i);
  bool orientation(RectPtrArray::iterator i);
