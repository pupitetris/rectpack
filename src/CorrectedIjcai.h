...
#ifndef CORRECTEDIJCAI_H
#define CORRECTEDIJCAI_H
...
class CorrectedIjcai : public IntPack {

 public:
  CorrectedIjcai();
  virtual ~CorrectedIjcai();
 ...
 protected:
  ...
  inline bool locMid(Rectangle* r, UInt nMinY,
		     ...
		     const RectPtrArray::const_iterator& iEnd);
  inline bool locRight(Rectangle* r, UInt nMinY,
		       RectPtrArray::iterator& iBegin,
		       const RectPtrArray::const_iterator& iEnd);
