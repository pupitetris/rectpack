...
#ifndef CORNERVARIABLES_H
#define CORNERVARIABLES_H
...
class CornerVariables : public std::vector<std::map<UInt, std::set<Int> > > {
 public:
  ...
  void print() const;
  bool emptyDomain(const CornerValues& cv, const Grid* pGrid) const;
};

#endif // CORNERVARIABLES_H
