...
#ifndef HEIGHTWIDTHLENGTH_H
#define HEIGHTWIDTHLENGTH_H
...
class HeightWidthLength : public DimsFunctor {
 public:
  static DimsFunctor* get();
  static HeightWidthLength* singleton;

  HeightWidthLength();
  virtual ~HeightWidthLength();
