...
const UInt& LengthHeightWidth::d1(const Dimensions* r) const {
  return(r->m_nLength);
}
...
const UInt& LengthHeightWidth::d2(const Dimensions* r) const {
  return(r->m_nHeight);
}
...
const UInt& LengthHeightWidth::d3(const Dimensions* r) const {
  return(r->m_nWidth);
}
