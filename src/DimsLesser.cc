...
DimsLesser::DimsLesser(const DimsFunctor* pDims) :
  m_pDims(pDims) {
}

DimsLesser::DimsLesser(const DimsLesser& src) :
  m_pDims(src.m_pDims) {
}

DimsLesser::~DimsLesser() {
}

bool DimsLesser::operator()(const Rectangle* r1,
...
bool DimsLesser::operator()(const Rectangle& r1,
			     const Rectangle& r2) const {
  if(m_pDims->d3(r1) != m_pDims->d3(r2))
...
bool DimsLesser::operator()(const RDimensions* r1,
